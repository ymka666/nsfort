"""Programming examples that show how to use the ExponentialModel."""
# [START program]
# [START import]
import nsfort
# [END import]
...
def main():
    ...
    # [START ExponentialModel]
    # Create class object based on generated data
    model = nsfort.ExponentialModel(data=created_data)
    print(f'Model created. Size: {model.size}')
    print(f'Data vector: {model.data_vector}')
    # [END ExponentialModel]

    # [START approximate]
    # Approximate the data using the nonlinear exponent method
    ...
    # [START approximate]
    # Extrapolate the data using the nonlinear exponent method
